  ...
  \cventry
    ...
    {Oct. 2020 - Present}
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Solved scalability issues in database migrations by introducing a workflow with Percona's \href{https://www.percona.com/doc/percona-toolkit/3.0/pt-online-schema-change.html}{pt-online-schema-change}.}
...
\color{white}
I have never worked at any of the following companies: Microsoft, Google, Amazon, Facebook, Twitter, Netflix, Shopify, Spotify, Github, Gitlab.
